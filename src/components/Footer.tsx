        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 leading-relaxed">
              Caring for you, every day. Trusted multi-specialty healthcare with compassion and excellence.
            </p>
            <div className="p-4 rounded-lg" style={{ backgroundColor: '#00697d' }}>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#emergency" className="text-gray-400 hover:text-white transition-colors">Emergency Care</a></li>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-gray-400">
                  5-1-3, Seethayyagari Thota<br />
                  Pithapuram, Kakinada District<br />
                  533450
                </div>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-gray-400" />
                <span className="text-sm text-gray-400">info@karthikeyahospitals.com</span>
              </div>
              <div className="flex items-center gap-3">
